        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasDishwasher = table.Column<bool>(type: "boolean", nullable: false),
                    IsPetFriendly = table.Column<bool>(type: "boolean", nullable: false),
                    HasHomeOfficeSpace = table.Column<bool>(type: "boolean", nullable: false),
                    HasLargeKitchen = table.Column<bool>(type: "boolean", nullable: false),
                    HasView = table.Column<bool>(type: "boolean", nullable: false),
                    IsFurnished = table.Column<bool>(type: "boolean", nullable: false),
                    ApartmentStyle = table.Column<string>(type: "text", nullable: false),
                    NoiseLevel = table.Column<string>(type: "text", nullable: false),
                    Sunlight = table.Column<string>(type: "text", nullable: false),
                    MetroDistanceMinutes = table.Column<int>(type: "integer", nullable: true),
                    GymDistanceMinutes = table.Column<int>(type: "integer", nullable: true),
                    ParkDistanceMinutes = table.Column<int>(type: "integer", nullable: true),
                    SchoolDistanceMinutes = table.Column<int>(type: "integer", nullable: true),
                    KindergartenDistanceMinutes = table.Column<int>(type: "integer", nullable: true),
                    UniversityDistanceMinutes = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
