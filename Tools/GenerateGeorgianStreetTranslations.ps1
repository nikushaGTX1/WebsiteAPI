...
$lines.Add("            ? georgian")
$lines.Add("            : GeorgianStreetTransliterator.Transliterate(englishName));")
$lines.Add("")
...
$lines.Add("")
$lines.Add("    public static string? FindEnglishPartial(string georgianName)")
$lines.Add("    {")
$lines.Add("        var term = georgianName.Trim();")
$lines.Add("        if (term.Length < 2)")
$lines.Add("        {")
$lines.Add("            return null;")
$lines.Add("        }")
$lines.Add("")
$lines.Add("        var matches = StreetData.StreetsList")
$lines.Add("            .SelectMany(area => area.StreetNames)")
$lines.Add("            .Distinct(StringComparer.OrdinalIgnoreCase)")
$lines.Add("            .Where(english =>")
$lines.Add("                Find(english)?.Contains(")
$lines.Add("                    term,")
$lines.Add("                    StringComparison.OrdinalIgnoreCase) == true)")
$lines.Add("            .Take(2)")
$lines.Add("            .ToList();")
$lines.Add("")
$lines.Add("        return matches.Count == 1 ? matches[0] : null;")
$lines.Add("    }")
$lines.Add("}")
